...
public class FTFLICareCreateDietChartActivity extends Activity implements OnClickListener, OnDateSetListener, OnTimeSetListener {
	...
	long mActivityId = 0;
	DietChartDataSource activityDS = null;
	DietChartModel mUpdateActivity = null;
	DietChartDataSource mActivityDataSource = null;
			...
			if (mStrActivityID != null) {
				...
				if (activityDS.updateData(mActivityId, activityDataInsert) == true) {
					...
					//finish();
					 ...
					 startActivity(new Intent(FTFLICareCreateDietChartActivity.this,
