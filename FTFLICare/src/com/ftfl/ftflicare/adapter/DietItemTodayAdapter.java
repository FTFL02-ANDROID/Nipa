...
public class DietItemTodayAdapter extends ArrayAdapter<DietChartModel>{
	...
	public DietItemTodayAdapter(Activity context, List<DietChartModel> allDailyDietChart) {
